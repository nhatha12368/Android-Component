package com.example.androidconponent
...
import com.example.androidconponent.databinding.ActivityLanguageBinding
...
class LanguageActivity : AppCompatActivity() {
    ...
    private fun handClickItemLanguage(position: Int) {
        ...
        sharedPreferencesManager?.saveString(KEY_NAME_LANGUAGE, languages?.nameLanguage.toString())
        finish()
    }

    private fun setCheckBox(isCheck: Boolean?) {
        mBinding.imgChecked.isVisible = isCheck!!
    }
